...
class MessageBuilder(object):
    ...
    def updateProfile(update_dict, opt_user_id=None, opt_request_id=None):
        ...
        msg = {"MsgType": "U38", "UpdateReqID": opt_request_id, "Fields": update_dict}
        if opt_user_id:
    ...
    @staticmethod
    def getBrokerList(
        status_list, country=None, page=None, page_size=100, opt_request_id=None
    ):
        if not opt_request_id:
            opt_request_id = random.randint(1, 10000000)

        msg = {"MsgType": "U28", "BrokerListReqID": opt_request_id}
        if page:
            msg["Page"] = page
    ...
    @staticmethod
    def verifyCustomer(
        broker_id, client_id, verify, verification_data, opt_request_id=None
    ):
        if not opt_request_id:
            opt_request_id = random.randint(1, 10000000)
    ...
    def processDeposit(
        ...
        msg = {"MsgType": "B0", "ProcessDepositReqID": opt_request_id, "Action": action}
    ...
    def requestPositions(request_id=None, client_id=None):
        if not request_id:
            request_id = random.randint(1, 10000000)
        msg = {"MsgType": "U42", "PositionReqID": request_id}
        if client_id:
            msg["ClientID"] = client_id
        return msg
